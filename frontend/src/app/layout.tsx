...
export const metadata: Metadata = {
  ...
  // No `icons` here on purpose: declaring it overrides Next's file convention,
  // and this used to point at /logo.png — a 2000px transparent canvas that is
  // ~60% empty padding, so browsers drew the mark as a speck. app/favicon.ico,
  // app/icon.png and app/apple-icon.png are picked up automatically and are
  // cropped to the mark.
  other: {
